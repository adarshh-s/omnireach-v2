      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className={`absolute top-full mt-1.5 w-72 max-w-[85vw] bg-surface/95 backdrop-blur-3xl border border-border-strong rounded-xl shadow-elevated py-1.5 z-50 max-h-80 overflow-y-auto ${
